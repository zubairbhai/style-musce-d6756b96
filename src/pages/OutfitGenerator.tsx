    ...
    try {
      ...
      if (error) {
        ...
        if (errorBody.error === "Payment required") {
          setOutfit({ text: "⚠️ **AI credits exhausted.** Your StyleSense AI usage limit has been reached. Please add more credits in your workspace settings (Settings → Workspace → Usage) to continue generating outfits." });
